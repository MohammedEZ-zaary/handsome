...
std::string
ContentTypeMapper::getContentTypeHeader(const std::string &filePath) {
  std::string extension =
      extractFileExtension(filePath); // Extract the extension
...
std::string
ContentTypeMapper::extractFileExtension(const std::string &filePath) {
